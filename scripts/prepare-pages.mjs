...
export const RUNTIME=['.nojekyll','index.html','manifest.webmanifest','sw.js','controle.html','assets/studio.css','assets/engine.js','assets/studio-art.js','assets/studio.js','icons/studio.svg','icons/studio-180.png','icons/studio-192.png','icons/studio-512.png'];
