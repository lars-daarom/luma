/* Luma 5.3.0: versioned, scope-local offline shell. No saved-game deletion. */
const VERSION='5.3.0',CACHE='luma-v'+VERSION+'-pages-'+self.registration.scope;
const FILES=['./index.html','./manifest.webmanifest?v=5.3.0','./assets/studio.css?v=5.3.0','./assets/atlas.css?v=5.3.0','./assets/journey.css?v=5.3.0','./assets/engine.js?v=5.3.0','./assets/studio-art.js?v=5.3.0','./assets/atlas-art.js?v=5.3.0','./assets/journey.js?v=5.3.0','./assets/studio.js?v=5.3.0','./icons/studio.svg?v=5.3.0','./icons/studio-180.png?v=5.3.0','./icons/studio-192.png?v=5.3.0','./icons/studio-512.png?v=5.3.0'];
